...
\item[$\triangleright$] Motivated self-starter who loves learning new things and solving complex problems with data, statistics, and algorithms.

\item[$\triangleright$] Thrives on teams with a wide ranging mix of technical and non-technical colleagues.
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item Good foundation on the statistical concepts underlying data science.
	\item Experience data wrangling and munging with a variety of data formats.
