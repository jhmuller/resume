...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item Python (10 years) and it's ecosystem: notebooks, pandas, numpy, et cetera.
		\item \textbf {Knowledge of and experience with factor models, back testing and optimization}. 
	\item Exposure to Options and Futures.
			\item Experience with quantitative investing both on the sell side(4 years) and on the buy side(5 years).
	\item Basic understanding of Annuity products.
