...
\item[$\triangleright$] Experience using statistical modeling and machine learning algorithms to develop predictive models and insights.

\item[$\triangleright$] Solid background in data science and a track record of developing and implementing advanced analytic solutions.
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item Experience with data visualization tools such as Spotfire, Tableau.
