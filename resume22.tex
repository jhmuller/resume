...
\begin{itemize}
\item clustering asset managers by shared holdings from SEC Edgar filings.
\item forecasting the change in the monthly jobs number using a variety of covariates
\item ranking college football teams.
\end{document}
