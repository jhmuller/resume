...
\item[$\triangleright$] Passion for learning new tools/skills and for delivering great products.

\item[$\triangleright$]  Able to turn data analysis into compelling stories.
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item Experience with data visualization tools such as Spotfire and Matplotlib.
     ...
     \item Able to collaborate effectively with a variety of cross-functional partners/teams.
\end{itemize}
\end{multicols}
\vspace{-10pt}
