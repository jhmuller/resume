...
\item[$\triangleright$] Motivated self-starter who loves  working with clients and stakeholders to define and then execute on solutions that add value.

\item[$\triangleright$] Experience managing and mentoring junior staff.
\end{itemize}
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item Experience working at Scale
