...
https://www.linkedin.com/in/quantjohn/ 
 \textcolor{red} {$\diamondsuit$} https://github.com/jhmuller/jhmuller.github.io
...
{ \textbf{ {Overview}}}}{Overview}}\label{overview}}
\begin{itemize}
\tightlist

\item[$\triangleright$] Computer Scientist(Ph.D.), Data Scientist, and Finance Quant with over 15 years of experience solving analytic problems, building models and adding value in a variety of industries. 

\item[$\triangleright$] Data Science practitioner with multiple certificates in analytics/data science/visualization and over 6 years of experience building supervised and unsupervised models ranging from k-means, random forests, boosted trees, and regression to LLMs, GenAI, RAG, embeddings et ceterra.  
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item In depth knowledge of Machine Learning algorithms ranging from regression to ensemble methods to deep neural network.	
	\item Scikit learn, keras/tensoflow,and pytorch.
	\item SQL, Git
	\item Many courses and projects on GenAI topics using tools such as HuggingFace, Langchain, Langgraph, CrewAI, and ChromaDB to build NLP applications using LLMs.
	\item Experience with both open and closed source LLMs: e.g. OpenAI, Anthropic, Llama.
	\item Experience with time series forecasting.
	\item Experience building both supervised and unsupervised models.
		\item Experience with data visualization tools such as Spotfire and Matplotlib.
	\item Experience with large data sets: PySpark, Impala and Hive.

     \item Excellent communication skills.
     \item Experience as team leader/manager as well as individual contributor.
...
\item Designed and built a dashboard for Portfolio Managers to compare returns and exposures for sets of portfolios, allowing them to identify both anomalies and opportunities in their portfolio strategies. 
 \item  Proposed and built and innovative graph ML
  model that can use product attributes as well as web traffic data.  This was important because
  it addressed the issue of new products which have no 
    history of view data.

\item Built prototype LLM backed apps using Langchain, Langgraph, Hugging Face,  OpenAI, CrewAI and other tools. See Github link above.
...
{\textbf {\textcolor{blue}{Data Scientist}}, Wells Fargo Bank
\hfill  
	Oct 2025 - present
	
Working with Internal Audit to apply GenAI to improve their efficiency.
This includes generation of level 1 risks from level 2 ratings
and finding patterns in year-over-year risk rating changes.
Using Python, Langchain, Pandas, GCP, et cetera.

{\textbf {\textcolor{blue}{Data Scientist}}, Bank of America
 \hfill  
	Oct 2024 - June 2025
	
Member of the Financial Crimes/Anti Money Laundering group.  Working on improving the efficiency of the process which searches billions of transactions and millions of entity records.
  Using Python, SQL, 
Teradata, hive, Spark and other such tools.




{\textbf {\textcolor{blue}{Senior Analyst/Data Scientist}}, TIAA \hfill
	Nov 2023 - July 2024
	
Member of a team using ML/AI and NLP to make document processing more efficient.  Using Python, SQL, 
Google cloud, Vertex AI, et cetera.
Projects  include: 
\begin{itemize}
\item  classify written customer feedback as a complaint or not and route accordingly. and

\item automatically generate a response letter to customers once their issue has been resolved.
\end{itemize}

		 
\vspace{3pt}
{\textbf {\textcolor{blue}{Contract Python Programmer}}, Bank of America
  \hfill  
Dec 2022 - Oct 2023

Developing Python and SQL tools to give the bank a more flexible process for detecting and  managing  data issues. 
\begin{itemize}
\tightlist
...
{\textbf {\textcolor{blue}{Data Scientist}}, Lowe's
 \hfill  
Nov 2021 - Apr 2022\\
\vspace{-10pt}
\begin{itemize}
...
\textbf {\textcolor{blue}{Python and SQL Code Reviewer}}, PNC Bank
\hfill 
...
\textbf {\textcolor{blue}{VP and Lead Analyst}}, Acadian Asset Management
 \hfill 
Feb 2013 -  Mar 2018
...
\textbf{\textcolor{blue}  {Strategic and Technical Lead}}, Enter the Data
 \hfill  
 %\textcolor{red}{$\diamondsuit$} 
 \hfill Feb 2012 - Feb 2013\\
\emph {My own brand for Data Science and Computer Science consulting}\\
Worked with clients to understand their business needs and translate them into analytic/data science solutions using R.
\begin{itemize}
\tightlist
...
\textbf {\textcolor{blue}{VP and Analytic Lead}}, State Street Associates
\hfill  
%  \textcolor{red}{$\diamondsuit$} \hfill 
  Aug 2007 - Feb 2012 
...
\textbf {\textcolor{blue}{VP and Analytic Lead}}, Bank of America
% \textcolor{red}{$\diamondsuit$} \hfill 
 \hfill 
% \textcolor{red}{$\diamondsuit$} \hfill 
Oct 2001 -  Aug 2007
