...
\item Built prototype NLP/LLM backed apps using Lanchain, Langgraph and other tools.
...
Member of the \emph{Intelligent Retirement Operations} group using ML/AI and NLP to make document processing more efficient.  One NLP project is to classify written customer feedback as a "complaint" or not and route accordingly.  Another NLP effort involves automatically generating a response letter to customers once their issue has been resolved.  In both cases we are using Google Cloud Vertex AI, Python, sql, pandas, et cetera.  
...
\textbf {\textcolor{blue}{Lead Analyst}} \hfill @ 
%\textcolor{red}{$\diamondsuit$} \hfill
...
\subsubsection{}\label{ssa}}
 {\textbf {\textcolor{blue} {Analytic and Visualization Lead}} \hfill @ 
% \textcolor{red}{$\diamondsuit$} \hfill
