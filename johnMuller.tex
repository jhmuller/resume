...
\item[$\triangleright$] Data Science practitioner with multiple certificates in analytics/data science and over 6 years of experience building supervised and unsupervised models ranging from k-means, random forests, boosted trees, and regression to LLMs and graph NNs.  Also experience with exploratory data analysis and visualization.
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item SQL, Git, R
	\item Experience with HuggingFace, Langchain,Langgraph,  NLP (nltk) to build applications using LLMs.
...
\item Built prototype NLP/LLM backed apps using Langchain, Langgraph and other tools. See Github link above.
...
Member of a team using ML/AI and NLP to make document processing more efficient.
Projects hosted on Google cloud Vertex AI and  include: 
\begin{itemize}
