...
{\textbf {\textcolor{blue}{Senior Analyst/Data Scientist}} \hfill @ 
	%\textcolor{red}{$\diamondsuit$} \hfill
	\textbf{TIAA} \hfill  
	%\textcolor{red}{$\diamondsuit$} \hfill 
	Nov 2023 - July 2024
...
\textbf {\textcolor{blue}{Python and SQL Code Reviewer}} \hfill @ 
%\textcolor{red}{$\diamondsuit$} \hfill @ 
...
\textbf {\textcolor{blue}{VP and Lead Analyst}} \hfill @ 
%\textcolor{red}{$\diamondsuit$} \hfill
...
\subsubsection{}\label{ssa}}
 {\textbf {\textcolor{blue} {VP and Analytic and Visualization Lead}} \hfill @ 
% \textcolor{red}{$\diamondsuit$} \hfill
...
\textbf {\textcolor{blue}{VP and Analytic Lead}} \hfill  @ 
% \textcolor{red}{$\diamondsuit$} \hfill 
 \textbf{Bank of America} \hfill 
% \textcolor{red}{$\diamondsuit$} \hfill 
Oct 2001 -  Aug 2007
