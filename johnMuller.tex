...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item In depth knowledge of Machine Learning algorithms ranging from regression to ensemble methods to deep neural network models.	
	\item Scikit learn, keras/tensoflow,and pytorch.
	\item SQL, Git, R
	\item Many courses and projects on GenAI topics using tools such as HuggingFace, Langchain, CrewAI, and ChromaDB to build NLP applications using LLMs.
...
\item Built prototype NLP/LLM backed apps using Langchain, OpenAI, CrewAI and other tools. See Github link above.
