...
\item[$\triangleright$] Data Science practitioner with multiple certificates in analytics/data science and over 6 years of experience building supervised and unsupervised models as well as exploratory data analysis and data visualization.

\item[$\triangleright$]  Excellent problem-solving, critical-thinking, and presentation skills.

\item[$\triangleright$] Experience as a team leader/manager as well as writing production code as an individual contributor.
