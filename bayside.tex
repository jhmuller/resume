...
\item[$\triangleright$] Experience using statistical modeling and machine learning algorithms to develop predictive models and insights from start to finish.

\item[$\triangleright$]  Fast learner, team player with a can-do attitude.
