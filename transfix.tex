...
\item[$\triangleright$] Excited to work in an industry disruptive setting such as trucking and transportation.

\item[$\triangleright$] Familiar with other players in the trucking technology space such as Convoy.
\end{itemize}
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item Machine Learning algorithms ranging from regression to ensemble tree methods to neural networks.	
	\item Scikit learn, keras/tensoflow,and pytorch.
	\item SQL (15 years), Git
	\item Experience working at scale with large data sets using Spark
	\item Experience putting models and code into production
	\item Experience with time series forecasting and analysis
