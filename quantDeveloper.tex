...
\item [$\triangleright$] Experience with quantitative investing both on the sell side(4 years) and on the buy side(5 years).
...
\begin{multicols}{2}
  \begin{itemize}
	...
	\item {Knowledge of and experience with factor models, back testing and systematic equity strategies}. 
	\item Experience building data access libraries.
	\item Familiar with Docker for containerization and Airflow for scheduling.
	\item Familiar with High Performance Computing.
...
\item Implemented adding transaction costs
