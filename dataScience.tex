...
{\textbf {\textcolor{blue}{Senior Analyst/Data Scientist}} \hfill 
	...
	Part of \emph{Intelligent Retirement Operations} group using ML/AI to make document processing more efficient. Efforts include 
		 Text Classification and Text Extraction from PDF files.  
