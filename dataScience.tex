...
Member of the \emph{Intelligent Retirement Operations} group using ML/AI to make document processing more efficient. Efforts include:
		 Document classification and response letter generation.		 
